...
def train():
    ...
    # 加载训练数据
    dataset = MyDataset(tfms=None,n_class=11)
    dataloader = DataLoader(dataset, batch_size=32, shuffle=True, num_workers=2)
    dataloader_val = DataLoader(MyDataset(tfms=None, n_class=11, train=False), batch_size=4, shuffle=True, num_workers=2)
